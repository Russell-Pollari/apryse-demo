...
(exports => {
  ...
  exports.runDigitalSignaturesTest = () => {
    ...
    const CustomSigningAPI = async (
      ...
      const cms_signature = await PDFNet.DigitalSignatureField.generateCMSSignature(signer_cert, chain_certs, digest_algorithm_oid, signature_algorithm_oid, signature_value, signedAttrs);
